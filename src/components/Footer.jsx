  ...
  return(
    <div className='bg-white text-center py-6 text-sm'>
        <div className='flex justify-center gap-x-4 text-blue text-lg mb-4'>
          <a href="https://www.linkedin.com/in/yooran/"><FontAwesomeIcon icon={faLinkedinIn} className='text-xl' /></a>
          <a href="https://github.com/yoo-ran"><FontAwesomeIcon icon={faGithub} className='text-xl' /></a>
