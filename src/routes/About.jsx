...
function About() {
  ...
  return (
    <div className={`flex flex-col justify-center items-center transition-[width] gap-y-32 lg:gap-y-40 xl:gap-y-52
    ${sharedState == "true" ? 
    ...
    >
      ...
      {/* About Me */}
      <section id='aboutSection' className='flex flex-col items-center gap-y-6 3xl:gap-y-20 xl:w-8/12'>
      ...
      {/* Values */}
      <section id='valueSection' className='flex flex-col items-center gap-y-8 md:gap-y-14 2xl:gap-y-20 xl:w-8/12'>
      ...
      {/* Hobbies */}
      <section id='hobbySection' className='overflow-hidden flex flex-col gap-y-8 justify-center items-center mb-40 xl:w-8/12'>
        ...
        <article className='w-11/12 md:w-8/12 lg:text-base xl:text-lg 2xl:text-2xl'>
          <p>
        ...
        <article className='w-full h-96 md:w-8/12 relative flex flex-col items-center md:h-80 lg:h-64 xl:h-[28rem] 2xl:h-96   3xl:h-[30rem]'>
          <div id='hobby01' className="absolute opacity-0 bg-cover bg-center py-10 px-4 h-full w-full lg:h-[22rem] xl:h-[28rem] 2xl:h-[32rem] 3xl:h-[34rem] flex justify-center items-center" style={{ backgroundImage: `url(${hobby01})` }}>
            <p className='text-white z-50 md:w-11/12 text-sm md:text-lg lg:text-lg 2xl:text-2xl 3xl:text-3xl leading-6'>
          ...
          <div id='hobby02' className="absolute opacity-0 bg-cover bg-center py-10 px-4 h-full w-full lg:h-[22rem] xl:h-[28rem] 2xl:h-[32rem] 3xl:h-[34rem] flex justify-center items-center"  style={{ backgroundImage: `url(${hobby02})` }}>
          ...
          <div id='hobby03' className="absolute opacity-0 bg-cover bg-bottom py-10 px-4 h-full w-full lg:h-[22rem] xl:h-[28rem] 2xl:h-[32rem] 3xl:h-[34rem] flex justify-center items-center"  style={{ backgroundImage: `url(${hobby03})` }}>
            <p className='text-white z-50 md:w-11/12 text-sm md:text-lg lg:text-lg 2xl:text-2xl 3xl:text-3xl leading-5'>
