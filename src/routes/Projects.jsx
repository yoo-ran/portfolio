  ...
  return (
    <main>
      ...
      <section className='h-80 bg-white text-center flex justify-center items-center z-10 w-full'>
        <h2 className='font-bold font-head text-3xl text-blue'>
          Projects{' '}
          <FontAwesomeIcon icon={faFaceSmileWink} className='text-blue' />
        </h2>
      </section>
        ...
        <div className='flex flex-col justify-center items-center gap-y-8 w-10/12 md:w-full lg:w-8/12  xl:w-6/12'>
          <div className='w-full flex justify-between'>
            <input
              ...
              className='border-b-2 border-lightBlue focus:outline-0 focus:border-gray transition duration-200 px-2 pt-1 w-11/12 lg:text-lg'
            />
            <button>
          ...
          <div className='flex flex-wrap justify-center md:justify-between gap-x-2 gap-y-4 w-full'>
            {filterKeyword.map((item, id) => (
              <button
                ...
                className={` rounded-full px-3 py-1 text-sm lg:text-base hover:bg-gray hover:text-white ${
                  clicked == item
                    ? 'bg-gray text-white'
      ...
      <section
        id='prjSection'
        className=' relative my-10 lg:my-20 flex flex-col justify-center items-center gap-y-20 lg:gap-y-28  w-full lg:w-8/12'
      >
        {category.map((item) => (
          <div
            key={item.id}
          ...
          >
            ...
            <div className='w-full md:w-3/4 lg:w-[32rem] xl:w-7/12 flex flex-col justify-center h-full gap-y-6'>
              <div>
                <div className='font-bold text-xl lg:text-2xl mb-1 font-head'>
                  {item.title}
                </div>
                <div className=''>
              ...
              <div>
                ...
                <div className='py-4 flex justify-between text-base xl:text-lg'>
                  <a
                    ...
                    target='_blank'
                    className='inline-block rounded-full text-center text-blue hover:text-gray'
                  >
                    Github <FontAwesomeIcon icon={faArrowRight} />
                  </a>
                  <a
                    href={item.webLink}
                    aria-label={`${item.title} Live Website`}
                    target='_blank'
                    className='inline-block rounded-full text-center text-blue hover:text-gray'
                  >
                    Website <FontAwesomeIcon icon={faArrowUpRightFromSquare} />
                  </a>
                  <a
                    href={item.more}
                    aria-label={`${item.title} Detail`}
                    className='inline-block rounded-full text-center text-red hover:text-gray'
                  >
                    More +
                  </a>
                </div>
